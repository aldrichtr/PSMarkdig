@{
    ...
    ModuleVersion = '0.1.0'
    Description = 'Manage markdown content using the Markdig library. Provides pipeline-safe wrappers around MarkdownDocument for reading, manipulating, and writing Markdown.'
