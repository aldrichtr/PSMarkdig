@{
    ...
    <# [markdown]
     ...
     # Uses only the custom rules defined in the specified paths to the analysis. To still use the built-in rules,
     #  add the `-IncludeDefaultRules` switch.
     #
   ...
   #---------------------------------------------------------------------------------------------------------------
    ...
    <# [markdown]
     ...
     # uses only the custom rules defined in the specified file or directory. To include the built-in rules,
     # use the **IncludeDefaultRules** parameter.
     #>
